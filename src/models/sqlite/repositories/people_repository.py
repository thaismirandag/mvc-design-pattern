...
from src.models.sqlite.interfaces.people_repository import PeopleRepositoryInterfaces

class PeopleRepository(PeopleRepositoryInterfaces):
        ...
        with self.__db_connection as database:
            try:
                person = (
                    ...
                    .with_entities(PeopleTable.first_name,
